...
**Figmaデータソース**: `specs/stories/[STORY_ID]-[title]/ui-design/outline.json` または `components/[Screen].json`
...
**Figmaキャッシュディレクトリ**: `specs/stories/[STORY_ID]-[title]/ui-design/`
...
**データソース**: `specs/stories/[STORY_ID]-[title]/ui-design/variables.json`
...
**Figmaデータソース**: `specs/stories/[STORY_ID]-[title]/ui-design/components/[ComponentName].json`
