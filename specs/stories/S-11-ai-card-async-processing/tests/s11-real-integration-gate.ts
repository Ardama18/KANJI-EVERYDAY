...
const rows = await db.query<{ queue_exists: boolean; contract_ok: boolean; acl_ok: boolean; bucket_ok: boolean }>(`
	SELECT
...
await db.execute(`
	...
	BEGIN
		...
		PERFORM public.mark_ai_upload_cleanup(
			'15000000-0000-4000-8000-00000000000a','15000000-0000-4000-8000-000000000010',NULL
		);
