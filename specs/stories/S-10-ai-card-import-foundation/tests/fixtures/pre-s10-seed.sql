-- Frozen pre-S-10 seed. Keep independent from supabase/seed.sql so upgrade tests
-- always start from the legacy global card_key contract.
BEGIN;
...
INSERT INTO public.users_profile (user_id, display_name, timezone, parent_mode_enabled)
VALUES (
  '00000000-0000-4000-8000-000000000001'::uuid,
  'Seed Owner',
  'Asia/Tokyo',
...
INSERT INTO public.decks (id, owner_user_id, name, new_limit_per_day)
VALUES (
...
upserted_seed_cards AS (
  INSERT INTO public.cards (
    owner_user_id, visibility, skill, pattern, front_text, back_text,
...
resolved_seed_cards AS (
  SELECT id, card_key FROM upserted_seed_cards
  UNION
  SELECT cards.id, cards.card_key
